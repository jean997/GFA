...
ft <- sumstatFactors:::est_L_flash2(Z_hat = Z_hat_indep, fit = fit2$fit, tol = 1e-7)

fit1k <- sumstatFactors:::est_L_flash2(Z_hat = Z_hat[1:1000,], fit = fit2$fit)

fit500 <- sumstatFactors:::est_L_flash2(Z_hat = Z_hat[1:500,], fit = fit2$fit)
```
