...
Looking at the frobenious norm values, we can see that all GFA estimates that included the nuisance correlation were very similar, though using the p-thresholding nuisance matrix is a little worse than using the LDSC matrix.
```{r}
