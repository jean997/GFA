...
Finally, we can fit GFA using the estimated or true residual correlation matrix.
...
If we compare these results with the results where we omitted the `R` argument, we can see that no adjusting for the nuisance correlation has resulted in thre extra factors being estimated that don't match any true factors. 
