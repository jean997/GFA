...
### Flash with var_type="zero" and greedy initialization
...
In addition to comparing the objectives, we can evaluate the fit by masking data and then computing the sum of squared differences between observed and imputed values. The code below does this 10 times for each method, masking a random set of 5\% of non-missing summary statistics each time.
