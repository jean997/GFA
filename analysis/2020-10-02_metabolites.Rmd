...
```
These values are quite large for the first factors and then substantially less than 1 for factors 5, 6, 7, and 9. Overall, these results don't look like typical GWAS results. 
